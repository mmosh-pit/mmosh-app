  ...
  return (
    <div className="min-h-[29.875rem] xl:w-[36.188rem] bg-[#271114] rounded-[1.25rem] pt-[1.563rem] pb-[0.938rem] pl-[3.25rem] pe-[3.063rem] max-md:px-5 max-md:py-8">
      ...
      <div className="flex flex-col gap-[0.938rem] mt-[0.625rem]">
        <LikertQuestion
          name="q1"
          text="Competing fiercely on the field"
          value={form.q1}
          onChange={(v) => setForm({ ...form, q1: v })}
        />
        <LikertQuestion
          name="q2"
          text="Coaching your team with a bold strategy"
          value={form.q2}
          onChange={(v) => setForm({ ...form, q2: v })}
        />
        <LikertQuestion
          name="q3"
          text="Cheering your team to victory"
          value={form.q3}
          onChange={(v) => setForm({ ...form, q3: v })}
        />
        <LikertQuestion
          name="q4"
          text="Refereeing as fair a game as possible "
          value={form.q4}
