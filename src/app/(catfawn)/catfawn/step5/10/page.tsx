...
const LIKERT_QUESTIONS = [
    { id: "q1", text: "Let them know you are offended and ask for an immediate apology." },
    { id: "q2", text: "Start thinking of how you will make them pay." },
    { id: "q3", text: "Say or do something destructive on the spur of the moment." },
    { id: "q4", text: "Confront them and ask how they could do this to you." },
  ];
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (parsed.currentStep && parsed.currentStep !== "catfawn/step5/10") {
