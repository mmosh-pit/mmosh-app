...
const Step5VC11 = () => {
  ...
  const LIKERT_QUESTIONS = [
    ...
    {
      id: "q3",
      text: "Have retreated into silent rigidity rather than face an issue.",
    },
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (result?.completedSteps !== undefined && result?.completedSteps < 15) {
  ...
  const submitStep5 = async () => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        completedSteps:
          cachedData.completedSteps && cachedData.completedSteps < 16
            ? 16
    ...
    <>
      ...
      <div className="min-h-[29.875rem] xl:w-[36.188rem] bg-[#271114] rounded-[1.25rem] pt-[1.563rem] pb-[0.938rem] pl-[3.25rem] pe-[3.063rem] max-md:px-5 max-md:py-8">
        <h2 className="relative font-poppinsNew text-center text-[1.563rem] max-md:text-lg leading-[100%] font-bold bg-gradient-to-r from-[#FFFFFF] to-[#FFFFFF88] bg-clip-text text-transparent">
          <BackArrowVW onClick={() => router.replace("/catfawn/step5/10")} />
          ...
          <div className="font-normal font-avenir absolute top-1/2 -translate-y-1/2 right-0 text-[#FFFFFFE5] text-[0.75rem] -tracking-[0.04em]">
            <span className="font-avenirNext font-extrabold">11</span>/12
          </div>
        </h2>
        ...
        <p className="max-sm:text-base text-[0.938rem] text-[#FFFFFFE5] font-avenirLtStd max-md:text-sm font-bold leading-snug lg:leading-[110%] mt-3 lg:mt-[1.813rem] -tracking-[0.07em]">
          Someone close to you is upset with you. Is it most likely because you:{" "}
        </p>
