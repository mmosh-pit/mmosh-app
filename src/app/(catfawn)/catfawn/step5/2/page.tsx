...
const Step5VC2 = () => {
  ...
  const LIKERT_QUESTIONS = [
    { id: "q1", text: "Research the issue and consider it carefully, searching for a solution" },
    { id: "q2", text: "Remind both of them of your loyalty to them and your willingness to work with them to resolve the problem." },
    { id: "q3", text: "Talk with each in turn, waiting for a flash of insight in the moment to help you resolve the situation" },
    { id: "q4", text: "Try to understand how each of them feels and find a way to support both of them" },
  ];
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (parsed.currentStep && parsed.currentStep !== "catfawn/step5/2") {
