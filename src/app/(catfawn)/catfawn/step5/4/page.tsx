...
const Step5VC4 = () => {
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (result?.completedSteps !== undefined && result?.completedSteps < 8) {
  ...
  return (
    <>
      ...
      <form className="min-h-[29.875rem] xl:w-[36.188rem] bg-[#271114] rounded-[1.25rem] pt-[1.563rem] pb-[0.938rem] px-[3.125rem] max-md:px-5 max-md:py-8" onSubmit={submitStep5}>
        <h2 className="relative font-poppinsNew text-center text-[1.563rem] max-md:text-lg leading-[100%] font-bold bg-gradient-to-r from-[#FFFFFF] to-[#FFFFFF88] bg-clip-text text-transparent">
          <BackArrowVW onClick={() => router.replace("/catfawn/step5/3")} />
          ...
          <div className="font-normal font-avenir absolute top-1/2 -translate-y-1/2 right-0 text-[#FFFFFFE5] text-[0.75rem] -tracking-[0.04em]">
            <span className="font-avenirNext font-extrabold">4</span>/12
          </div>
        </h2>
        ...
        <p className="max-sm:text-base text-[0.938rem] text-[#FFFFFFE5] font-avenirLtStd max-md:text-sm font-bold leading-snug lg:leading-[110%] mt-3 lg:mt-[1.875rem] -tracking-[0.07em]">
          You have a new model airplane you’re flying by remote control. Do you:{" "}
        </p>
