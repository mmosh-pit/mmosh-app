...
const Step5VC6 = () => {
  ...
  const LIKERT_QUESTIONS = [
    {
      id: "q1",
      text: "Have members of the group debate their ideas, and then you make a final decision.",
    },
    {
      id: "q2",
      text: "Gather data by talking to people individually and make a considered decision.",
    },
    {
      id: "q3",
      text: "Give a pep talk that inspires people to think creatively and then see what the group comes up with.",
    },
    {
      id: "q4",
      text: "Follow your feelings to the best solution and present it to the group, while remaining open to their input.",
    },
  ];
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (result?.completedSteps !== undefined && result?.completedSteps < 10) {
 ...
 const createMessage = (message: string, type: "error" | "success") => {
  ...
  return (
    <>
      ...
      <form className="min-h-[29.875rem] xl:w-[36.188rem] bg-[#271114] rounded-[1.25rem] pt-[1.563rem] pb-[0.938rem] pl-[3.25rem] pe-[3.063rem] max-md:px-5 max-md:py-8" onClick={submitStep5}>
        <h2 className="relative font-poppinsNew text-center text-[1.563rem] max-md:text-lg leading-[100%] font-bold bg-gradient-to-r from-[#FFFFFF] to-[#FFFFFF88] bg-clip-text text-transparent">
          ...
          <div className="font-normal font-avenirNext absolute top-1/2 -translate-y-1/2 right-0 text-[#FFFFFFE5] text-[0.75rem] -tracking-[0.04em]">
            <span className="font-extrabold">6</span>/12
          </div>
        </h2>
        ...
        <p className="text-[0.938rem] text-[#FFFFFFE5] font-avenirLtStd max-md:text-sm font-bold leading-snug lg:leading-[110%] mt-2 lg:mt-[1.813rem] -tracking-[0.07em]">
