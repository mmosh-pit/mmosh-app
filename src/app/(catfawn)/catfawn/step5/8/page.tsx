...
const LIKERT_QUESTIONS = [
    ...
    { id: "q2", text: "Think about why these changes are being proposed and what consequences they will have." },
    { id: "q3", text: "Help ensure all opinions are heard and try to come to a consensus." },
    { id: "q4", text: "Listen to the various ideas and encourage everyone to participate." },
  ];
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (parsed.currentStep && parsed.currentStep !== "catfawn/step5/8") {
