...
const Step5VC8 = () => {
  ...
  const LIKERT_QUESTIONS = [
    { id: "q1", text: "Show up early to explain your point of view." },
    {
      id: "q2",
      text: "Think about why these changes are being proposed and what consequences they will have.",
    },
    {
      id: "q3",
      text: "Help ensure all opinions are heard and try to come to a consensus.",
    },
    {
      id: "q4",
      text: "Listen to the various ideas and encourage everyone to participate.",
    },
  ];
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (result?.completedSteps !== undefined && result?.completedSteps < 12) {
  ...
  const submitStep5 = async () => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...cachedData,
        currentStep: "catfawn/step5/9",
        likertAnswers: {
          ...(existingData.likertAnswers || {}),
          ...likertAnswers,
        },
        completedSteps:
          cachedData.completedSteps && cachedData.completedSteps < 13
            ? 13
            : cachedData.completedSteps,
      })
    );
    router.replace("/catfawn/step5/9");
  };
