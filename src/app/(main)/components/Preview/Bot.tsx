...
const Bot = ({ onActivate }: Props) => {
  return (
    <div className="flex flex-col px-2 items-center rounded-2xl border-[#FFFFFF80] bg-[rgba(255,255,255,0.02)] mt-[30px] border-[1px] py-8 px-4">
      <div className="flex justify-center items-center w-[300px] md:h-[250px] h-[200px] md:w-[600px] mb-2">
        <video
          className="w-full rounded-lg md:h-[250px] h-[200px] w-[300px] md:w-[600px]"
          muted
          loop={false}
          controls
          playsInline
