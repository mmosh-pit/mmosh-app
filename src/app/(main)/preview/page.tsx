...
"
        ...
        <div className="lg:flex my-10 mx-auto justify-between lg:w-[90rem]">
          <div className="mt-24">
            ...
            <p className="lg:text-left text-center lg:text-lg text-sm text-[#FFFFFFC7]  mt-5 mb-2">
              Ready to explore what’s possible together? <br /> Reach out. We’d love to
              hear what you’re building—and see if <br /> Kinship is the right home for
              you.
            </p>
          </div>
   ...
   I agree to receive communications about the CAT-FAWN Connection early access program and launch updates.
  </label>
            </form>
          </div>
        </div>
