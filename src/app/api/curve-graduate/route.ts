...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    let marketCap = bondingResult.reserveBalanceFromBonding.toNumber() / web3Consts.LAMPORTS_PER_OPOS;
    ...
    const supply = Math.ceil(marketCap / 0.001) * web3Consts.LAMPORTS_PER_OPOS;
