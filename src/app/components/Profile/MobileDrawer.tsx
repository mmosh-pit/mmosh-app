  ...
  return (
    <div className="drawer">
      ...
      <div className="drawer-side">
        ...
        ></label>
        <div className="flex flex-col menu divide-y p-4 w-80 min-h-full bg-base-200 text-base-content">
          <div className="flex flex-col">
            <p className="text-base text-white mb-4">Home</p>

            <p className="text-base text-white mt-4">Website</p>
          </div>
