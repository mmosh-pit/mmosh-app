    ...
    const chooseInvitationType = (currentInvitationType: any) => {
      ...
      const mintOfferPass = async () => {
        ...
        if (validateFields(true)) {
            ...
            try {
                setButtonText("Uploading offer metadata...");
                let offerBody = {
                  name: fields.name,
                  symbol: fields.symbol,
                  description: fields.desc,
                  image: fields.image.preview,
                  enternal_url: "https://www.kinship.codes/" + symbol + "/" + fields.symbol,
                  ...
                  attributes: [
                    ...
                    },
                    {
                      ...
                      value: projectDetail.project.name
                    },
                    {
                      trait_type: "Agent Symbol",
                      value: projectDetail.project.symbol.toUpperCase()
                    },
                    {
                    ...
                    {
                      trait_type: "Payments",
                      value: fields.pricetype === "onetime" ? "Single" : "Subscription"
                    },
                    {
                      trait_type: "Denomination",
                      value: projectDetail.coins[0].symbol.toUpperCase()
                    },
                    {
                ...
                const res1: any = await communityConnection.mintGenesisPass({
                    ...
                    mintKp: offerKeyPair,
                    input: {
                    oposToken: new anchor.web3.PublicKey(projectDetail.coins[0].key),
                    profileMintingCost,
                ...
                if (fields.invitationType != "none") {
                    ...
                    const invitebody = {
                        ...
                        "projects/" +
                        projectDetail.project.symbol + "/" + fields.symbol,
          ...
          <div className="container mx-auto relative mb-8">
                ...
                {projectDetail &&
                    <>
                      {projectDetail.coins.length == 0 &&
                         <p className="text-sub-title-font-size light-gray-color text-center para-line-height text-light-gray leading-4 mb-10">Tokenomics still pending to be set</p>
                      }
                    </>
                }
            ...
            {offerPageContent == "list" &&
              <div className="flex justify-end">
                <button className="btn btn-primary bg-[#6607FF] text-white border-none hover:bg-primary hover:text-white md:mt-0 mt-5" onClick={()=>{setCurrentMenu("offer"); setOfferPageContent("add")}}>
                  Add an Offer
                </button>
              </div>
            }
                             ...
                             <>
                                {projectDetail.offers.length > 0 &&
                                  <button
                                    ...
                                    onClick={()=>{setOfferPageContent("list")}}
                                  >
                                    Back
                                  </button>
                                }
             ...
             <>
                ...
                {!offerLoading && offers.length > 0 &&
                  <div className="container mx-auto">
                    <div
                        className="grid grid-cols-1 xl:grid-cols-3 2xl:grid-cols-3 gap-6 px-4 flex mt-4 overflow-x-hidden"
                      >
