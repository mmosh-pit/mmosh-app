  ...
  const submitAction = async () => {
    try {
      ...
      if (project.isExternalCoin) {
        ...
        mintKey = await communityConnection.createCoin(
          coins.name,
          coins.symbol,
          coinMetaURI,
          coins.supply * web3Consts.LAMPORTS_PER_OPOS,
          9,
        );
      }
      ...
      if (!project.isExternalCoin) {
        ...
        let mmoshOwner: any = await userConn.getNftProfileOwner(
        ...
        if (mmoshOwner.profileHolder != anchor.web3.PublicKey.default) {
          stakeData.push({
            ...
            value: Math.ceil(
              coins.supply * (2 / 100) * web3Consts.LAMPORTS_PER_OPOS,
            ),
            duration: 0,
            type: "liqudity",
          });
        ...
        if (presale.minPresale > 0) {
          stakeData.push({
            ...
            duration: new Date(
              new Date(
                presale.presaleEndDate + " " + presale.presaleEndTime,
              ).toUTCString(),
            ).valueOf(),
            type: "presale",
          });
        ...
        stakeData.push({
          ...
          value: Math.ceil(
            Math.ceil(liquidity.mmosh * web3Consts.LAMPORTS_PER_OPOS),
          ),
          type: "liqudity",
        });
      ...
      const profileMintingCost = new anchor.BN(
        calcNonDecimalValue(Number(project.passPrice), 9),
      );
      ...
      // save project
      let presaleStart = new Date(
        presale.presaleStartDate + " " + presale.presaleStartTime,
      ).toUTCString();
      ...
      navigate.push("/create/project/" + project.symbol + "/join");
    } catch (error) {
      ...
      <div className="background-content">
          ...
          <div className="relative w-full flex flex-col justify-center items-center pt-5">
            <div className="max-w-md">
              ...
              <h3 className="text-center text-white font-goudy text-sub-title-font-size pt-2.5">
                Step {project.isExternalCoin ? "4" : "10"}
              </h3>
              ...
              <p className="text-para-font-size light-gray-color text-center para-line-height pt-2.5 text-light-gray leading-4">
                When you deploy your Project, your Launchpasses will appear on
                the launchpad and your Project will appear in the directory.
                While we do not censor Projects, listings on our web app and in
                our telegram bot are guided by our{" "}
                <span className="underline">community standards.</span>
              </p>
            </div>
          </div>
        </div>
        <div className="backdrop-container rounded-xl border border-white border-opacity-20 my-10 container mx-auto">
          ...
          <div className="p-5">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              <div className="col-span-3">
                <div className="md:mb-3.5">
                  <h3 className="text-sub-title-font-size text-while font-poppins mb-3.5">
                    Project Pass
                  </h3>
                  <div>
                    <h3 className="text-sub-title-font-size text-while font-poppins text-center">
                      {project.name}
                    </h3>
                    <div>
                    ...
                    <p className="text-header-small-font-size text-white mt-2 text-center">
                      {project.symbol}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <div className="col-span-4">
                      ...
                      <div className="grid grid-flow-col justify-stretch gap-4">
                        <div>
                          <p className="text-para-font-size">
                            Fully Diluted Value (FDV)
                          </p>
                          <p className="text-para-font-size bg-black bg-opacity-[0.2] px-3.5 py-2.5 rounded-md">
                            {coins.listingPrice * coins.supply}
                          </p>
                        </div>
                      </div>
                    </div>
                    {!project.isExternalCoin && (
                      <div className="col-span-5">
                        ...
                        <p className="text-para-font-size bg-black bg-opacity-[0.2] px-3.5 py-2.5 rounded-md h-full">
                          {coins.desc}
                        </p>
                      </div>
                    )}
                  ...
                  {presale.minPresale > 0 && (
                    <>
                      ...
                      <div className="grid md:grid-flow-col justify-stretch gap-4">
                        <div>
                          <p className="text-para-font-size">
                            Maximum Supply for presale
                          </p>
                          <p className="text-para-font-size bg-black bg-opacity-[0.2] px-3.5 py-2.5 rounded-md">
                            {coins.supply * (presale.maxPresale / 100)}
                          </p>
                        </div>
                        <div>
                        ...
                        <div>
                          <p className="text-para-font-size">
                            Minimum tokens sold required to close presale
                          </p>
                          <p className="text-para-font-size bg-black bg-opacity-[0.2] px-3.5 py-2.5 rounded-md">
                            {coins.supply *
                              (presale.maxPresale / 100) *
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                  ...
                  <div className="col-span-6">
                    ...
                    <div className="grid md:grid-flow-col justify-stretch gap-4">
                      ...
                      <div>
                        <p className="text-para-font-size">
                          Royalties to Promoter
                        </p>
                        <p className="text-para-font-size bg-black bg-opacity-[0.2] px-3.5 py-2.5 rounded-md">
                          {passItem.promoterRoyalty}%
                        </p>
                      </div>
                      <div>
                        <p className="text-para-font-size">
                          Promoter Royalty to Scout
                        </p>
                        <p className="text-para-font-size bg-black bg-opacity-[0.2] px-3.5 py-2.5 rounded-md">
                          {passItem.scoutRoyalty}%
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {!project.isExternalCoin && (
                  <div className="col-span-4">
                    ...
                    <div className="grid grid-cols-12 gap-4 mb-5">
                      <div className="col-span-4">
                        <p className="text-header-small-font-size">
                          Distribution Plan
                        </p>
                      </div>
                      <div className="col-span-4">
                    ...
                    {tokenomics.map((tokenomicsItem: any, i) => (
                      <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-4">
                          <p className="text-para-font-size">
                            {tokenomicsItem.type} {tokenomicsItem.value}%
                          </p>
                        </div>
                        <div className="col-span-4">
                          <div className="text-center">
                            <p className="text-para-font-size text-center bg-black bg-opacity-[0.2] px-3.5 py-2.5 inline-block">
                              {tokenomicsItem.cliff.months}
                            </p>
                          </div>
                        </div>
                        <div className="col-span-4">
                  ...
                  <div className="col-span-4">
                    ...
                    <div className="flex">
                      ...
                      <div className="pl-5 pt-5">
                        {tokenomicschart.map(
                          (tokenomicschartItem: any, i: any) => (
                            <div className="flex">
                              <div
                                className={
                                  "w-2.5 h-2.5 rounded-full relative top-1"
                                }
                                style={{
                                  backgroundColor: tokenomicschartItem.color,
                                }}
                              ></div>
                              <p className="pl-2.5 text-header-small-font-size">
                                {tokenomicschartItem.name}
                              </p>
                            </div>
                          ),
                        )}
            ...
            {!project.isExternalCoin && (
              <>
                <h3 className="text-sub-title-font-size text-while font-poppins text-center pt-10">
                  Summary of Costs
                </h3>
                <p className="text-header-small-font-size text-white text-center mt-1.5">
                  for Liquidity Pool
                </p>
                <div className="flex justify-center mt-3.5">
                  <div className="flex justify-center mr-3.5">
                    <p className="text-header-small-font-size text-white mr-1">
                      USDC
                    </p>
                    <p className="text-header-small-font-size text-white">
                      {liquidity.usd.toFixed(2)}
                    </p>
                  </div>
                  <div className="flex justify-center mr-3.5">
                    <p className="text-header-small-font-size text-white mr-1">
            ...
            <div className="flex justify-center mt-3.5">
              <p className="text-para-font-size text-white min-w-24 mr-3.5">
                MMOSH
              </p>
            ...
            {!project.isExternalCoin && (
              <div className="flex justify-center">
                <p className="text-para-font-size text-white mr-3.5">
                  Current Balance
                </p>
                <p className="text-para-font-size text-white min-w-24">
                  {profileInfo?.usdcBalance.toFixed(2)} USDC
                </p>
              </div>
            )}
            <div className="flex justify-center">
            ...
            {!project.isExternalCoin && (
              <div className="flex justify-center">
                ...
                <p className="text-para-font-size text-white min-w-24">
                  {profileInfo?.mmoshBalance.toFixed(2)} MMOSH
                </p>
              </div>
            )}
          </div>
