  ...
  const unstakeAction = async (type:any, value:any) => {
    ...
    try {
      ...
      if(result.data.status) {
        ...
        const tx = anchor.web3.VersionedTransaction.deserialize(Buffer.from(result.data.transaction,"base64"))
                  ...
                  <div className="background-content-claim p-3.5 rounded-xl">
                      <div className="grid grid-cols-2">
                          <div className="border-r border-white border-opacity-20">
                            <h3 className="text-left text-white text-sub-title-font-size border-b border-white border-opacity-20 pb-3.5 mb-3.5">PTVB</h3>
                            <div>
                          ...
                          <div>
                            <h3 className="text-left text-sub-title-font-size border-b border-white border-opacity-20 pb-3.5 mb-3.5 pl-3.5">PTVR</h3>
              ...
              <div className="border-container p-px rounded-xl">
                  <div className="background-content-claim p-3.5 rounded-xl">
                      <div className="grid grid-cols-2">
                          ...
                          <div>
                            <h3 className="text-left text-white text-sub-title-font-size border-b border-white border-opacity-20 pb-3.5 mb-3.5 pl-3.5">PTVR</h3>
                            <div className="pl-3.5">
                            <div className="flex mt-1.5">
                                <label className="text-header-small-font-size text-white font-poppins font-semibold leading-6 w-24">Hold in Wallet:</label>
                  ...
                  <div className="text-center">
                    ...
                    <div>
                      {(loader.active && loader.type === "Blue") &&
                         <button className="btn-sm bg-claim-color text-white border-none hover:bg-claim-color hover:text-white w-32 rounded-md">Unstaking...</button>
                      }
                      {!loader.active &&
                         <button className="btn-sm bg-claim-color text-white border-none hover:bg-claim-color hover:text-white w-32 rounded-md" onClick={()=>{unstakeAction("Blue", blueDetails.unstakeable)}}>Unstake PTVB</button>
                      }
                    </div>
                ...
                <div>
                  <div className="text-center">
                    ...
                    <div>
                      ...
                      {!loader.active &&
                         <button className="btn-sm bg-claim-color text-white border-none hover:bg-claim-color hover:text-white w-32 rounded-md" onClick={()=>{unstakeAction("Red", redDetails.unstakeable)}}>Unstake PTVR</button>
                      }
                    </div>
                  </div>
