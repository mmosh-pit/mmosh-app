                     ...
                     <div className="grid grid-cols-2">
                        <div className="border-r border-white border-opacity-20">
                          ...
                          <div className="flex justify-center mt-1.5">
                              ...
                              <span className="text-header-small-font-size text-white font-poppins leading-6">5,00,000</span>
                          </div>
                          <div className="flex justify-center mt-1.5">
            ...
            <div className="grid grid-cols-2">
              <div>
                <div className="text-center">
                  <div className="bg-black bg-opacity-[0.2] text-header-small-font-size text-white font-poppins py-2.5 px-10 inline-block font-semibold mb-2.5">22,000 PTVB</div>
                  <div>
              ...
              <div>
                <div className="text-center">
                  <div className="bg-black bg-opacity-[0.2] text-header-small-font-size text-white font-poppins py-2.5 px-10 inline-block font-semibold mb-2.5">22,000 PTVR</div>
                  <div>
