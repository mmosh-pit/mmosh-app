...
export const getquote = async (params: JupQuoteParams) => {
   try {
       const result = await axios.get(process.env.NEXT_PUBLIC_JUPITER_API + "/v6/quote?inputMint="+params.inputMint+"&outputMint="+params.outputMint+"&amount="+params.lamportValue+"&slippageBps=50")
